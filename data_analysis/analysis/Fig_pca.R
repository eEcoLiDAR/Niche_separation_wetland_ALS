...
p1=fviz_pca_var(pca.env,axes = c(1, 2), col.var = "black",repel = TRUE,labelsize = 7)

p1+labs(x = "PCA 1 (37.2%)", y = "PCA 2 (23.9%)")+theme(axis.text=element_text(family="Sans",size=25),axis.title=element_text(family="Sans",size=25))+ggtitle("a) PCA")+
  theme(text=element_text(family="Sans", size=25))
...
legend("topright", legend=c("Background 100%","Background 50%","Niche filling 100% = 64%", "Niche filling 50% = 4.3%"),
...
legend("topright", legend=c("Background 100%","Background 50%","Niche filling 100% = 94%", "Niche filling 50% = 19.5%"),
...
legend("topright", legend=c("Background 100%","Background 50%","Niche filling 100% = 76%", "Niche filling 50% = 13.5%"),
